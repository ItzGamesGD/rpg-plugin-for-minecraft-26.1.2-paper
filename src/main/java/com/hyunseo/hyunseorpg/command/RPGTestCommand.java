...
public final class RPGTestCommand implements CommandExecutor, TabCompleter {
    ...
    public RPGTestCommand(CoinService coins, RPGItemRegistry itemRegistry, RPGItemService items,
                          ...
                          GatewayPrototypeService gatewayPrototype) {
        this.coins = coins;
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        if (args.length == 1) return filter(List.of("give", "coins", "setcoins", "hand", "inspect", "maxhand", "maxgrowth", "option-roll", "boss", "gateway", "basic-swarm", "orbital-core", "reload"), args[0]);
