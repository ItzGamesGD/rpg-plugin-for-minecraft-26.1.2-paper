...
public record ThunderAxeConfig(int hitThreshold, double strikeDamage, double chainRadius,
    ...
    public static ThunderAxeConfig from(ConfigService config) {
        ...
        return new ThunderAxeConfig(
                ...
                config.getSpecialEquipmentDouble(p + "thunder-god-strike.first-distance", 2.0),
                config.getSpecialEquipmentDouble(p + "thunder-god-strike.distance-step", 4.0),
                ...
                config.getSpecialEquipmentDouble(v + "core-thickness", 0.18),
                config.getSpecialEquipmentDouble(v + "glow-thickness", 0.5),
                config.getSpecialEquipmentDouble(v + "segment-length", 2.5),
                config.getSpecialEquipmentDouble(v + "path-jitter", 1.2),
                config.getSpecialEquipmentDouble(v + "branch-chance", 0.12),
                config.getSpecialEquipmentInt(v + "max-branch-depth", 1),
                config.getSpecialEquipmentDouble(v + "branch-length", 3.0),
                config.getSpecialEquipmentInt(v + "lifetime-ticks", 6),
                ...
                config.getSpecialEquipmentDouble(p + "thunder-god-strike.vertical-lightning-height", 24.0));
    }
}
