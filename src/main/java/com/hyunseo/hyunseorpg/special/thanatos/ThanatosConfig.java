...
public record ThanatosConfig(int mortalDelayTicks, int mortalFallTicks, double mortalDamage, int mortalModel,
 ...
 public static ThanatosConfig from(ConfigService c) { String p="special-equipment.items.thanatos_mace.abilities.";
  return new ThanatosConfig(c.getSpecialEquipmentInt(p+"mortal.delay-ticks",100),c.getSpecialEquipmentInt(p+"mortal.fall-ticks",8),c.getSpecialEquipmentDouble(p+"mortal.damage",6),c.getSpecialEquipmentInt(p+"mortal.sword-custom-model-data",23601),
