...
import com.hyunseo.hyunseorpg.alchemy.brewing.VanillaBrewingStandAlchemyListener;
import com.hyunseo.hyunseorpg.alchemy.material.PaperAlchemyMaterialResolver;
...
public final class HyunseoRPGPlugin extends JavaPlugin {
    ...
    private void registerListeners() {
        ...
        getServer().getPluginManager().registerEvents(new VanillaBrewingStandAlchemyListener(
                this, alchemyRecipeRegistry, new PaperAlchemyMaterialResolver(itemService), potionPdc, potionFactory), this);
