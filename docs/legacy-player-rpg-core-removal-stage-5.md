...
RPG Level and RPG EXP are persistence-only domain values. They never mirror or
rewrite the player's Minecraft experience level or experience bar. Minecraft
continues to own XP orbs, death XP, enchanting, mending, and anvil payment.
